...
<div class="dishWidget">
  ...
  <div class="gap">
    ...
    <div class="menuAssets">
        ...
        <button class="button" onclick="addToCart(${premiumCuts[meatDishesIndex].id})">Add to basket</button>
    </div>
  </div>
</div>
`
...
<div class="dishWidget">
  ...
  <div class="gap">
    ...
    <div class="menuAssets">
        ...
        <button class="button" onclick="addToCart(${sideDishes[sideDishesIndex].id})">Add to basket</button>
    </div>
  </div>
</div>
`
...
<div class="dishWidget">
  ...
  <div class="gap">
    ...
    <div class="menuAssets">
        ...
        <button class="button" onclick="addToCart(${drinks[drinksIndex].id})">Add to basket</button>
    </div>
  </div>
</div>
`
